...
if __name__ == "__main__":
    ...
    a = np.array(df.values[:, 2])#res_new.csv
    a = np.expand_dims(a, axis=1)#res_new.csv
    ...
    print("=" * 50)
    print("输出文件:")
    print("  - optimization_results.json (优化结果和时间统计)")
    print("  - mcqrnn2_pred_denormalized.xlsx (反归一化预测结果)")