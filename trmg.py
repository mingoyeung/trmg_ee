...
if __name__ == "__main__":
    ...
    # 读取数据
    print("加载数据...")
    df = pd.read_csv('/home/a/桌面/Simulation code and data/trmg/imfreconstruction_TenneT.csv')#tvfemdresults_fujian.csv
    a = np.array(df.values[:, 0])#fujian不适用
    ...
    pred_df.to_excel('trmg1.xlsx', index=True)
