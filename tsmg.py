...
if __name__ == "__main__":
    ...
    # 读取数据
    print("加载数据...")
    df = pd.read_csv('/home/a/桌面/Simulation code and data/tsmg/sereconstruction.csv')#tsmg_fujian.csv
    ...
    pred_df.to_excel('tsmg4.xlsx', index=True)
